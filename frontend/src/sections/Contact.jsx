...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setStatus(
      "Contact form is currently unavailable. Please email me directly at medunraj3@gmail.com."
    );
      ...
      <div className="max-w-7xl mx-auto px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <form
            ...
            className="order-1 md:order-2 bg-white/60 backdrop-blur-md border border-gray-200 shadow-xl rounded-2xl p-6 sm:p-8 space-y-5"
          >
            ...
            <div className="bg-red-50 border-l-4 border-red-500 text-red-700 p-4 rounded-lg">
              <p className="font-semibold">
                ⚠️ Contact Form Currently Unavailable
              </p>

              <p className="text-sm mt-1">
                The contact form is under maintenance. Please contact me
                directly via email:
              </p>

              <a
                href="mailto:medunraj3@gmail.com"
                className="text-sm font-semibold underline block mt-2"
              >
                medunraj3@gmail.com
              </a>
            </div>
            ...
            <input
              ...
              disabled
              className="w-full p-3 sm:p-4 rounded-xl border border-gray-300 bg-gray-100 cursor-not-allowed"
            />
            ...
            <textarea
              ...
              disabled
              className="w-full p-3 sm:p-4 rounded-xl border border-gray-300 bg-gray-100 resize-none cursor-not-allowed"
            />
            ...
            <button
              type="submit"
              disabled
              className="w-full bg-gray-400 text-white py-3 sm:py-4 rounded-xl font-semibold cursor-not-allowed"
            >
              Currently Unavailable
            </button>

            {status && (
              <p className="text-sm text-center text-red-600">{status}</p>
            )}
          </form>
        </div>
      </div>
